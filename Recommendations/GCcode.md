...
This is the notable public model, GitFlow; documentation for that can be found here [https://datasift.github.io/gitflow/IntroducingGitFlow.html](https://datasift.github.io/gitflow/IntroducingGitFlow.html).
...
For ESDC – IITB, we have one organization group “ESDC – Innovation Information Technology Branch” [https://gccode.ssc-spc.gc.ca/iitb-dgiit](https://gccode.ssc-spc.gc.ca/iitb-dgiit).
